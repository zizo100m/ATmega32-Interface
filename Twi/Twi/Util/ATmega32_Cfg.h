...
/* TWI Registers */
#define TWI_BITRATE_REG        ((volatile uint8 *)0x20U)
#define TWI_CTRL_REG           ((volatile uint8 *)0x56U)
#define TWI_STATUS_REG         ((volatile uint8 *)0x21U)
#define TWI_SLAVE_ADDRESS_REG  ((volatile uint8 *)0x22U)
#define TWI_DATA_REG           ((volatile uint8 *)0x23U)
